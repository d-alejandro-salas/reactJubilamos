  ...
  return (
    <>
     ...
     <main>
        ...
        <p>Podes complementarlos con aportes que hagas como autónomo o monotributistas; asimismo el exceso de edad es importante para compensarlos, con 1 año de aporte por cada 2 años de edad excedente. Y también, según la normativa, podes completarlos a través de las moratorias previsionales vigentes.</p>
