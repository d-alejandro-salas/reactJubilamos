    ...
    <footer>
      <div className="footer__container">
        ...
        <section id="mapa">
          ...
          <p>
            <span className="addressMap" onClick={() => document.getElementById('mapa').classList.toggle('activo')}>Av. Santa Fe 1845</span><span id="verMapa" style={{ display: 'none' }}> (hacé click para visualizar el mapa)</span>, Ciudad Autónoma de Buenos Aires.<br />(Atención únicamente con cita previa).</p>
<br /><p>
*Realizamos trámites en todo el país. Contamos con personal y delegados en distintas provincias.
Con nosotros podés avanzar sin importar dónde vivas.
          </p><br />
